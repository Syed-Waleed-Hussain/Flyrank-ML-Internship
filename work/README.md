...
|---|---|---|
| `notebooks/w01_research_question.ipynb` | ML-02 | Done |
| `notebooks/w02_ml_task_framing.ipynb` | ML-03 | Done |
| `notebooks/w03_data_contract.ipynb` | ML-04 | Done |
| `notebooks/w03_feature_leakage_check.ipynb` | ML-05 | ☐ |
| `notebooks/w04_signal_audit.ipynb` | ML-06 | ☐ |
| `notebooks/w04_baseline_score.ipynb` | ML-07 | Done|
